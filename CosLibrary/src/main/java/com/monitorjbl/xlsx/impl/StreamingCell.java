...
public class StreamingCell implements Cell {
     ...
     * @throws UnsupportedOperationException Thrown if the type is not one
     * supported by the streamer. It may be possible to still read the value as
     * a supported type via
     * {@code getStringCellValue()}, {@code getNumericCellValue}, or
    ...
    /**
     * Get the value of the cell as a boolean. For strings we throw an
     * exception. For blank cells we return a false.
     *
     * @return the value of the cell as a date
     */
    @Override
