 ...
 */
@Entity
@Table(name = "tbl_PROVEEDOR_ALERTA")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TblPROVEEDORALERTA.findAll", query = "SELECT t FROM TblPROVEEDORALERTA t")})
public class TblPROVEEDORALERTA implements Serializable {
...
//    private static final long serialVersionUID = 1L;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblPROVEEDORALERTA)) {
            return false;
        }
        TblPROVEEDORALERTA other = (TblPROVEEDORALERTA) object;
    ...
    public String toString() {
        return "com.cossystem.core.pojos.proveedores.TblPROVEEDORALERTA[ idalerta=" + idalerta + " ]";
    }
