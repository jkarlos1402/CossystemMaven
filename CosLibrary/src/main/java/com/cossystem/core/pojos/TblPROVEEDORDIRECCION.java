 ...
 */
@Entity
@Table(name = "tbl_PROVEEDOR_DIRECCION")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TblPROVEEDORDIRECCION.findAll", query = "SELECT t FROM TblPROVEEDORDIRECCION t")})
public class TblPROVEEDORDIRECCION implements Serializable {
...
//    private static final long serialVersionUID = 1L;
    ...
    public TblPROVEEDORDIRECCION() {
    }

    public TblPROVEEDORDIRECCION(Integer iddireccion) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblPROVEEDORDIRECCION)) {
            return false;
        }
        TblPROVEEDORDIRECCION other = (TblPROVEEDORDIRECCION) object;
    ...
    public String toString() {
        return "com.cossystem.core.pojos.proveedores.TblPROVEEDORDIRECCION[ iddireccion=" + iddireccion + " ]";
    }
