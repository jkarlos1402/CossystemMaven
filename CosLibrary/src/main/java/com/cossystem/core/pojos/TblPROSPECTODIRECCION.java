 ...
 */
@Entity
@Table(name = "tbl_PROSPECTO_DIRECCION")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TblPROSPECTODIRECCION.findAll", query = "SELECT t FROM TblPROSPECTODIRECCION t")})
public class TblPROSPECTODIRECCION implements Serializable {
...
//    private static final long serialVersionUID = 1L;
    ...
    public TblPROSPECTODIRECCION() {
    }

    public TblPROSPECTODIRECCION(Integer iddireccion) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblPROSPECTODIRECCION)) {
            return false;
        }
        TblPROSPECTODIRECCION other = (TblPROSPECTODIRECCION) object;
    ...
    public String toString() {
        return "com.cossystem.core.pojos.prospecto.TblPROSPECTODIRECCION[ iddireccion=" + iddireccion + " ]";
    }
