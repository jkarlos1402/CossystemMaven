 ...
 */
@Entity
@Table(name = "tbl_PROSPECTO_OPORTUNIDAD")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TblPROSPECTOOPORTUNIDAD.findAll", query = "SELECT t FROM TblPROSPECTOOPORTUNIDAD t")})
public class TblPROSPECTOOPORTUNIDAD implements Serializable {
...
//    private static final long serialVersionUID = 1L;
    ...
    public TblPROSPECTOOPORTUNIDAD() {
    }

    public TblPROSPECTOOPORTUNIDAD(Integer idoportunidad) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblPROSPECTOOPORTUNIDAD)) {
            return false;
        }
        TblPROSPECTOOPORTUNIDAD other = (TblPROSPECTOOPORTUNIDAD) object;
    ...
    public String toString() {
        return "com.cossystem.core.pojos.prospecto.TblPROSPECTOOPORTUNIDAD[ idoportunidad=" + idoportunidad + " ]";
    }
