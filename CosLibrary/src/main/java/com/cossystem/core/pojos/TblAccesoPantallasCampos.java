 ...
 */
@Entity
@Table(name = "tbl_AccesoPantallasCampos")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TblAccesoPantallasCampos.findAll", query = "SELECT t FROM TblAccesoPantallasCampos t")})
public class TblAccesoPantallasCampos implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @Basic(optional = false)
    @Column(name = "IdPantallaCampos")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer idPantallaCampos;
    @Column(name = "IdTablaN")
    private Integer idTablaN;
    @Column(name = "IdTablaPadre")
    private Integer idTablaPadre;
    @Basic(optional = false)
    @Column(name = "NTabla")
    ...
    @Basic(optional = false)
    @Column(name = "Visible_Grid")
    private Boolean visibleGrid;
    @Column(name = "Visible_Detalle")
    ...
    public TblAccesoPantallasCampos() {
    }

    public TblAccesoPantallasCampos(Integer idPantallaCampos) {
        this.idPantallaCampos = idPantallaCampos;
    }

    public TblAccesoPantallasCampos(Integer idPantallaCampos, String nTabla, String nColumna, Boolean llavePrimeria, int idColumna, String tipoDato, int tamanio, String nombreFK, Boolean llaveForaneas, Boolean visibleGrid, Boolean cve1, Boolean cve2, String objetoPresentacion, String iDClave, String desCatalogo, String catalogo, Boolean idCatCompuesto, String iDClave1, String iDClave2) {
        this.idPantallaCampos = idPantallaCampos;
        this.nTabla = nTabla;
    ...
    public Integer getIdPantallaCampos() {
        return idPantallaCampos;
    }

    public void setIdPantallaCampos(Integer idPantallaCampos) {
        this.idPantallaCampos = idPantallaCampos;
    }

    public Integer getIdTablaN() {
        return idTablaN;
    }

    public void setIdTablaN(Integer idTablaN) {
        this.idTablaN = idTablaN;
    }

    public Integer getIdTablaPadre() {
        return idTablaPadre;
    }

    public void setIdTablaPadre(Integer idTablaPadre) {
        this.idTablaPadre = idTablaPadre;
    }
    ...
    public Boolean getVisibleDetalle() {
    ...
    public int hashCode() {
        int hash = 0;
        hash += (idPantallaCampos != null ? idPantallaCampos.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblAccesoPantallasCampos)) {
            return false;
        }
        TblAccesoPantallasCampos other = (TblAccesoPantallasCampos) object;
        if ((this.idPantallaCampos == null && other.idPantallaCampos != null) || (this.idPantallaCampos != null && !this.idPantallaCampos.equals(other.idPantallaCampos))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.cossystem.core.pojos.accesopantallas.TblAccesoPantallasCampos[ idPantallaCampos=" + idPantallaCampos + " ]";
    }
