 ...
 */
@Entity
@Table(name = "tbl_CLIENTE_ALERTA")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TblCLIENTEALERTA.findAll", query = "SELECT t FROM TblCLIENTEALERTA t")})
public class TblCLIENTEALERTA implements Serializable {
...
//    private static final long serialVersionUID = 1L;
    ...
    public TblCLIENTEALERTA() {
    }

    public TblCLIENTEALERTA(Integer idalerta) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblCLIENTEALERTA)) {
            return false;
        }
        TblCLIENTEALERTA other = (TblCLIENTEALERTA) object;
    ...
    public String toString() {
        return "com.cossystem.core.pojos.cliente.TblCLIENTEALERTA[ idalerta=" + idalerta + " ]";
    }
