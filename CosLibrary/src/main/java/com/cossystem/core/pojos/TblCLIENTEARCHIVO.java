 ...
 */
@Entity
@Table(name = "tbl_CLIENTE_ARCHIVO")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TblCLIENTEARCHIVO.findAll", query = "SELECT t FROM TblCLIENTEARCHIVO t")})
public class TblCLIENTEARCHIVO implements Serializable {
...
//    private static final long serialVersionUID = 1L;
    ...
    public TblCLIENTEARCHIVO() {
    }

    public TblCLIENTEARCHIVO(Integer idarchivo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblCLIENTEARCHIVO)) {
            return false;
        }
        TblCLIENTEARCHIVO other = (TblCLIENTEARCHIVO) object;
    ...
    public String toString() {
        return "com.cossystem.core.pojos.cliente.TblCLIENTEARCHIVO[ idarchivo=" + idarchivo + " ]";
    }
